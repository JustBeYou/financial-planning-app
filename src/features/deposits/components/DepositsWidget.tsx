...
export function DepositsWidget() {
    ...
    const formFields: FormField[] = [
        ...
        { id: "lengthMonths", name: "lengthMonths", label: "Length (months)", type: "number" },
    ];
    ...
    const columns: Column<Deposit>[] = [
        ...
        {
            header: "Amount",
            accessorKey: (deposit) => <span className="font-medium">{deposit.amount.toLocaleString()}</span>
        },
        { header: "Currency", accessorKey: "currency" },
        { header: "Start Date", accessorKey: (deposit) => formatDate(deposit.startDate) },
        {
            header: "Interest (%)",
        ...
        { header: "Maturity Date", accessorKey: (deposit) => formatDate(deposit.maturityDate) },
    ];

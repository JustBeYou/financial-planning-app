        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
            <div className="w-full max-w-md rounded-xl bg-white/10 p-8 backdrop-blur-sm">
                <h1 className="mb-6 text-center text-3xl font-bold">
                    Welcome to <span className="text-[hsl(280,100%,70%)]">Financial Planning</span> App
                </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full rounded-lg bg-[hsl(280,100%,70%)] px-4 py-3 font-semibold text-white transition hover:bg-[hsl(280,100%,60%)] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
